...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By WIA' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'WIA BOT' : process.env.BOT_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '917736994162,0' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "917736994162"
};
